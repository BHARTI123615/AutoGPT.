...
| [Cajal Scientific Paper Generator](block-integrations/llm.md#cajal-scientific-paper-generator) | Generates a citation-grounded scientific paper draft using verified arXiv references and a local Ollama model |
